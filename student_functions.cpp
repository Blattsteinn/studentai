...
void sort_students(std::vector<Studentas> &student_list) {
    ...
    switch (choice) {
        ...
        case 3:
            sort(student_list.begin(), student_list.end(),
                      [](const Studentas &a, const Studentas &b) { return a.galutinisVid < b.galutinisVid; }); // Ascending order
            break;
        case 4:
            sort( student_list.begin(), student_list.end(),
                      [](const Studentas &a, const Studentas &b) { return a.galutinisMed < b.galutinisMed; }); // Ascending order
            break;
        default:
            break;
    }
